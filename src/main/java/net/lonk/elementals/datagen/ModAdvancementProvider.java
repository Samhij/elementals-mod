...
public class ModAdvancementProvider extends FabricAdvancementProvider {
    ...
    @Override
    public void generateAdvancement(RegistryWrapper.WrapperLookup provider, Consumer<AdvancementEntry> consumer) {
        ...
        Advancement ignitedRubyHoe = Advancement.Builder.create()
                ...
                .build(consumer, "elementals/ignited_ruby_hoe").value();
    }
}
